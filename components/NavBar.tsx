          ...
          <div className="hidden md:flex items-center gap-8">
            {navItems.map((item) => (
              <button
                ...
                className={`text-sm font-medium uppercase tracking-widest transition-all duration-300 hover:text-white ${
                  currentPage === item.id ? 'text-white border-b border-white' : 'text-gray-500'
                }`}
              >
                {item.label}
              </button>
