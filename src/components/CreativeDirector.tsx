        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24 mb-32">
          <div className="flex-1">
            ...
            <div className="relative pt-12 md:pt-24">
               <h3 className="text-sm font-mono text-blue-500 mb-6">ERMO / CREATIVE DIRECTOR</h3>
               ...
               <p className="text-xl text-gray-400 leading-relaxed font-light">
                 ...
                 With over a decade in video production, creative direction, and high-end editing, 
