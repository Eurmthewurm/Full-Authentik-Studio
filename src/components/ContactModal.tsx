...
const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
   ...
   return (
      <div
         className={`fixed inset-0 z-[60] flex items-center justify-center transition-all duration-500 ${isOpen ? 'opacity-100 backdrop-blur-xl bg-black/80' : 'opacity-0 backdrop-blur-none pointer-events-none'
            }`}
      >
         <div
            className={`relative w-full max-w-6xl mx-auto p-4 md:p-8 transition-all duration-700 transform ${isOpen ? 'translate-y-0 scale-100' : 'translate-y-12 scale-95'
               }`}
         >
            {/* Close Button */}
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
               ...
               >
                  ...
                  <div className="relative z-10 flex items-center justify-between border-t border-white/10 pt-6">
                     <span className="text-sm font-bold text-white">Book Discovery Call</span>
               ...
               >
                  ...
                  <div className="relative z-10 flex-1">
                     ...
                     <p className="text-gray-500 text-sm leading-relaxed mb-6">
                        Consulting & Infrastructure for Personal Brands & Online Educators doing $50k/mo+.
                     </p>
            ...
            <div className="mt-12 text-center">
               <p className="text-xs text-gray-500 font-mono">
                  READY TO SCALE? <button onClick={handleBooking} className="text-white hover:text-blue-500 underline transition-colors">BOOK A DISCOVERY CALL</button>
               </p>
            </div>
         </div>
      </div>
