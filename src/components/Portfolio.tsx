    ...
    <section id="portfolio" className="py-24 px-4 bg-surface border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 max-w-2xl">
          <h2 className="text-4xl font-bold mb-4">The Creative Director</h2>
          <p className="text-gray-400 text-lg">
            Authentik Studio is led by a Creative Director with a track record of scaling service-based businesses and e-commerce brands. 
          ...
          <div className="mt-6 inline-block bg-white/5 px-4 py-2 rounded-lg border border-white/10">
             <span className="text-white font-bold">Track Record:</span> <span className="text-gray-400">J-Griff ($2M -> $8M in 1.5 Years)</span>
          </div>
        </div>
